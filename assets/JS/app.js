...
const countNumberOfParam= () => {
    ...
    if(strengthScore[strengthScore.length-1] <= 1){
        document.querySelector('.strengthLevel').innerHTML= "Muy débil!";
        ...
        document.querySelector('.strengthLevel').innerHTML= "Débil";
        ...
        document.querySelector('.strengthLevel').innerHTML= "Medio";
        ...
        document.querySelector('.strengthLevel').innerHTML= "Fuerte";
